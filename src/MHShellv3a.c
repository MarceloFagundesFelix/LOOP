/*************************************************************************************
   Arquivo:    "MHShellv3a.c" (Versao 3 Expande com comandos if e while)
...
int strCmd(char str[40], char cmd[5]){
   return(strcasecmp(str,cmd)==0);
}
...
void header()
{
   system("color 1F");     // fundo 1 (azul) e texto  F (branco)
                           //       0  preto          2  verde
   printf("   ======================================================\n");
   printf("   ===== MHShell v3.00 2021        IFF Macae Brazil =====\n");
...
void shell()
{
   ...
   while(cmdprompt)
   {
      ...
      switch (cmdprompt)
      {
      	case 0:
      	   system("cls");
      		printf(" Bye! (MHShell v.3.00 2021)\n\n");
